...
def test_every_domain_error_has_a_unique_code():
    """Codes are what the HTTP layer maps on in Phase 6; a duplicate would
    silently collapse two failures into one response."""
...
def test_the_expected_failures_are_all_present():
    """The taxonomy from phase-2 §2.2, verbatim."""
    expected = {
        "BookNotFound",
        "PostNotFound",
        "NotPostOwner",
